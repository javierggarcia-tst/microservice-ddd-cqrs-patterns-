...
namespace ServicioPrueba.Infrastructure.Processing
{
    public class DomainEventsDispatcher : IDomainEventsDispatcher
    {
        ...
        public DomainEventsDispatcher(IMediator mediator, ILifetimeScope scope, BDContext bdcontext)
        {
        ...
        {
            var domainEntities = this._bdContext.ChangeTracker
                .Entries<Entity>()
            ...
            //        type,
            //        data);
            //    this._bdContext.OutboxMessages.Add(outboxMessage);
            //}
        }
    }
}